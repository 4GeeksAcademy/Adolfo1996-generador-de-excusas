...
It depends on the language, but you have `./src/app.js`, `./src/style.css` and `app.jsl` respectively, you can add new `.html` as you please, just make sure to import it on the `app.js`.
